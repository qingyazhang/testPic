...
import com.example.testpic.utils.ToastUtil;
	...
	private void checkVersion() {
		new Thread(){
			public void run() {
				...
				try {
					//1,封装url地址
					URL url = new URL("http://www.zhizhihaha.cn/testPic/testPic.json");
					//2,开启一个链接
...
//					connection.setRequestMethod("POST");
					...
					if(connection.getResponseCode() == 200){
						...
						if(mLocalVersionCode<Integer.parseInt(versionCode)){
							...
							//进入应用程序主界面
							System.out.println("message what shi 进入主界面啊~~~~~~~~~~~~~~~~~");
							msg.what = ENTER_HOME;
						}
					}
					...
					System.out.println("发送message了啊！！！！！！！！！！！！");
